              ...
              <div className="row">
                <div className="col-lg-4">
                  ...
                  <p>
                    ...
                    nuestro equipo de servicio al cliente estés donde estés y a
                    cualquier hora.
                  </p>
                </div>
                <div className="col-lg-4">
                  ...
                  <p>
                    ...
                    estancia. Para formar parte de Airbnb, todos los anfitriones
                    deben tener una calificación mínima y cumplir nuestros
                ...
                <div className="col-lg-4">
                  ...
                  <p>
                    Nuestros anfitriones son pura hospitalidad. Disfruta de unas
                    sábanas recién puestas y atiende sus consejos sobre los
                    mejores sitios para ir a comer.
                  </p>
                </div>
              </div>
            </div>
